...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#060b18] text-white/[0.48] pt-24 pb-12 border-t border-white/[0.06] font-sans relative overflow-hidden">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2 max-w-sm">
                <input 
                  ...
                  className="flex-1 h-10 px-4 rounded-xl bg-white/[0.03] border border-white/[0.06] text-sm text-white placeholder:text-white/[0.2] focus:border-blue-500/50 focus:outline-none transition-all"
                />
                <button className="h-10 px-4 rounded-xl bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium transition-all flex items-center gap-2 shadow-[0_4px_12px_rgba(37,99,235,0.2)]">
                  Subscribe
                </button>
              </div>
            </div>
