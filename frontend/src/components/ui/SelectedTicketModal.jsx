      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-4">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-sm bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:border-blue-500 placeholder:text-gray-400"
          />
        </div>
        ...
        <Listbox value={filterRole} onChange={setFilterRole}>
          <div className="relative">
            ...
            <ListboxOptions className="absolute z-20 mt-1 w-full min-w-[140px] rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 py-1 shadow-lg focus:outline-none">
        ...
        <Listbox value={sortOrder} onChange={setSortOrder}>
          <div className="relative">
            ...
            <ListboxOptions className="absolute z-20 mt-1 w-full min-w-[130px] rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 py-1 shadow-lg focus:outline-none">
