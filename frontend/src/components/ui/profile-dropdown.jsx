...
export function ProfileDropdown({ showChevron = true }) {
  ...
  const handleTicketsClick = (e) => {
    ...
    console.log("Navigating to tickets:", path, "User role:", user?.role);
    navigate(path);
  };
  ...
  const handleProfileClick = (e) => {
    ...
    console.log("Navigating to profile:", path, "User role:", user?.role);
    navigate(path);
  };
        ...
        <DropdownMenuLabel className="font-normal">
          <div className="flex flex-col space-y-1">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary text-primary-foreground text-sm font-medium overflow-hidden">
                {currentAvatar ? (
                  <img src={currentAvatar} alt="Profile" className="w-full h-full object-cover" />
                ) : (
                  initials
